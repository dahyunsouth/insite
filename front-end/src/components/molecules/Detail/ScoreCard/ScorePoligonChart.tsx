...
/**
 * Lightweight SVG ScorePoligonChart without external deps.
 * - Responsive: fills parent width/height via 100% sized SVG.
 * - Renders grid, axes, labels, legend and series (solid/dashed).
 * - Single trade area focused version of RadarChart
 */
export default function ScorePoligonChart({
  labels,
  series,
  maxValue,
  levels = 5,
