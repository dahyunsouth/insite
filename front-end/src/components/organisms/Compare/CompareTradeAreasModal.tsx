 ...
 * - Right-side overlay (covers right 75% of viewport; left 25% sidebar untouched)
 * - Simple layout scaffolding only (dim + header + body placeholder + footer)
 */
  ...
  return createPortal(
    ...
    >
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center p-6">
        <div
          className={`${cardMaxWidthClass} rounded-3xl bg-white shadow-xl border border-black/5`}
        ...
        >
          ...
          <div className="relative px-8 pt-8 pb-4 border-b border-black/5">
            ...
            <p className="mt-1 text-sm text-gray-500">두 상권의 핵심 지표 비교</p>
          ...
          <div className="px-8 py-8">
            {/* Chart placeholder */}
            <div className="mx-auto h-[360px] rounded-2xl border border-gray-200 bg-gray-50 flex items-center justify-center text-gray-400">
              Radar Chart Placeholder
            </div>

            {/* Footer / quick compare selectors */}
            <div className="mt-10">
            ...
            {(() => {
              const metrics = [
                { key: "유동인구", a: "410 만 명", b: "410 만 명", aNum: 2702, bNum: 2508 },
                { key: "점포수", a: "97 개", b: "97 개", aNum: 2702, bNum: 2508 },
                { key: "상주인구", a: "2,702 명", b: "2,702 명", aNum: 2702, bNum: 2508 },
                { key: "직장인구", a: "5,275 명", b: "5,275 명", aNum: 2702, bNum: 2508 },
                { key: "집객시설", a: "5,275 명", b: "5,275 명", aNum: 2702, bNum: 2508 },
                { key: "상권변화지표", a: "HL 명", b: "HL 명", aNum: 2702, bNum: 2508 },
              ];
              const showThird = !leftOpen; // when sidebar is closed
              return (
                <div className={`mt-8 grid gap-x-10 ${showThird ? "grid-cols-[1fr_1fr_240px]" : "grid-cols-2"}`}>
                  {metrics.map((m, idx) => (
                    <React.Fragment key={m.key + idx}>
                      ...
                      {/* Third column: small bars (only when sidebar closed) */}
                      {showThird && (
