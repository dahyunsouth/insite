...
--
-- Table structure for table `trade_area_stor_cd_p`
--

DROP TABLE IF EXISTS `trade_area_stor_cd_p`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `trade_area_stor_cd_p` (
...
/*!50500 PARTITION BY RANGE  COLUMNS(STDR_YYQU_CD)
(PARTITION p20231 VALUES LESS THAN ('20232') ENGINE = InnoDB,
 PARTITION p20232 VALUES LESS THAN ('20233') ENGINE = InnoDB,
 PARTITION p20233 VALUES LESS THAN ('20234') ENGINE = InnoDB,
 PARTITION p20234 VALUES LESS THAN ('20241') ENGINE = InnoDB,
 PARTITION p20241 VALUES LESS THAN ('20242') ENGINE = InnoDB,
 PARTITION p20242 VALUES LESS THAN ('20243') ENGINE = InnoDB,
 PARTITION p20243 VALUES LESS THAN ('20244') ENGINE = InnoDB,
 PARTITION p20244 VALUES LESS THAN ('20245') ENGINE = InnoDB,
